...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 21, 2019 lúc 10:32 AM
...
('AMdemo', 'abc', 100000, 10, 'b', 'hinh2.jpg', 'TP02', 'NSX002'),
...
--
ALTER TABLE `khach_hang`
  ADD CONSTRAINT `FK_khachhang_taikhoan` FOREIGN KEY (`matk`) REFERENCES `tai_khoan` (`matk`);
